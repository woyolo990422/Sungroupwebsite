  ...
  var achievementsDetail = [
    {
      ...
      mediaCode:
      '<div><img style="width: auto;margin-right: 20px;" src="static/image/research_direction1-1.png"><img style="width: auto" src="static/image/research_direction1-2.png"></div>',
      details: [
