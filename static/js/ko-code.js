    ...
    var achievementsDetail = [
      {
        ...
        title1: '1.Machine learning and graph theory assisted crystal structure prediction method',
        title2: '2.High order tensor Passing Potential',
        title3: '3.Graphics Processing Units Molecular Dynamics',

        mediaCode1:
        '<div><img style="width: 50%;margin-right: 20px;" src="static/image/Magus1.jpg"><img style="width: 35%" src="static/image/Magus2.jpg"></div>',
        mediaCode2:
        '<div><img style="width: 55%;margin-right: 20px;" src="static/image/HotPP1.png"><img style="width: 28.5%" src="static/image/HotPP2.png"></div>',
        mediaCode3:
